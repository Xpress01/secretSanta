    ...
    return {
        ...
        genFields: function (num) {
            ...
            for (i = 0; i < num; i++) {
                ...
                /*html = '<div class="row"><div class="col"><label>%num%. Name:</label><input type="text" id="person-%id%" class="name-input" placeholder="Name"><div class="form-error-name">*Please Enter Valid Name</div></div><div class="col"><label>Email:</label><input type="text" id="email-%id%" class="email-input" placeholder="E-Mail"><div class="form-error-email">*Please Enter Valid E-Mail</div></div><div class="col"><label>Exclude:</label><select id="exclude-%id%" class="exclude-input">' + option + '</select></div></div><hr>';
                */
                
                html = '<tr><th scope="row">%num%.</th><td><input type="text" id="person-%id%" class="name-input" placeholder="Name"><div class="form-error-name">*Please Enter Valid Name</div></td><td><input type="text" id="email-%id%" class="email-input" placeholder="E-Mail"><div class="form-error-email">*Please Enter Valid E-Mail</div></td><td><select id="exclude-%id%" class="exclude-input">' + option + '</select></td></tr>';
